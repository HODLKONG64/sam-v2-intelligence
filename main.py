...
async def run_cycle():
    """Main v2 intelligence cycle: score → classify → save.

    NOTE: Keyword decay is intentionally NOT run here.
    HAY-MUM (sam-master-agent.py) is the sole owner of keyword decay.
    v2 is responsible for scoring and focus planning only.
    """
